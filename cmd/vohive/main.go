...
import (
	...
	proxyserver "github.com/travislee89/vohive/internal/proxy/server"
	"github.com/travislee89/vohive/internal/proxy/traffic"
	...
	"github.com/travislee89/vohive/internal/web"
	...
	if err := voiceGW.Start(context.Background()); err != nil {
		...
		if cfg.VoWiFi.VoiceGateway.SIP.Listen != "" {
			...
			if err != nil {
				...
				sipRegistrar.SetOnUpdate(voiceGW.HandleClientUpdate)
