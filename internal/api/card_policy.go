...
func (s *Server) handleGetCardPolicy(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"request_sms_delivery_reports": pol.RequestSMSDeliveryReports,
...
func (s *Server) handlePutCardPolicy(c *gin.Context) {
	...
	var req struct {
		...
		RequestSMSDeliveryReports *bool  `json:"request_sms_delivery_reports"`
	...
	if req.RequestSMSDeliveryReports != nil {
		pol.RequestSMSDeliveryReports = *req.RequestSMSDeliveryReports
	}
